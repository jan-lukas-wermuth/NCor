...
This package accompanies the paper "Proper Correlation Coefficients for Nominal Random Variables" by Jan-Lukas Wermuth. 

It provides an estimator for the coefficient proposed in the paper together with a confidence interval and a p-value for the corresponding independence test.

## Installation

You can install the development version of NCor from [GitHub](https://github.com/) with:
